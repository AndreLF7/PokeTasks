...
export const POKEMON_API_MINI_SPRITE_URL = (id: number) => `https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${id}.png`;
...
export const XP_FROM_MASTERBALL = 100;
...
export const MAX_SHARED_HABITS_PER_PARTNER = 1;
...
export const getTranslatedBallName = (type: BallType | null, plural: boolean = false): string => {
  if (!type) return '';
  switch (type) {
    case 'poke': return plural ? 'Poké Balls' : 'Poké Ball';
    case 'great': return 'Great Ball' + (plural ? 's' : '');
    case 'ultra': return 'Ultra Ball' + (plural ? 's' : '');
    case 'master': return 'Master Ball' + (plural ? 's' : '');
    default: return '';
  }
};

export const POKEBALL_WEIGHTED_POOL: WeightedPokemonEntry[] = [
  { id: 1, weight: 5 }, { id: 4, weight: 5 }, { id: 7, weight: 5 },
  { id: 10, weight: 15 }, { id: 13, weight: 15 }, { id: 16, weight: 15 }, { id: 19, weight: 15 },
  { id: 21, weight: 10 }, { id: 23, weight: 10 }, { id: 25, weight: 5 },
  { id: 27, weight: 10 }, { id: 29, weight: 10 }, { id: 32, weight: 10 },
  { id: 35, weight: 10 }, { id: 37, weight: 10 }, { id: 39, weight: 10 },
  { id: 41, weight: 10 }, { id: 43, weight: 10 }, { id: 46, weight: 10 },
  { id: 48, weight: 10 }, { id: 50, weight: 10 }, { id: 52, weight: 10 },
  { id: 54, weight: 10 }, { id: 56, weight: 10 }, { id: 58, weight: 10 },
  { id: 60, weight: 10 }, { id: 63, weight: 10 }, { id: 66, weight: 10 },
  { id: 69, weight: 10 }, { id: 72, weight: 10 }, { id: 74, weight: 10 },
  { id: 77, weight: 10 }, { id: 79, weight: 10 }, { id: 81, weight: 10 },
  { id: 84, weight: 10 }, { id: 86, weight: 10 }, { id: 88, weight: 10 },
  { id: 90, weight: 10 }, { id: 92, weight: 10 }, { id: 96, weight: 10 },
  { id: 98, weight: 10 }, { id: 100, weight: 10 }, { id: 102, weight: 10 },
  { id: 104, weight: 10 }, { id: 109, weight: 10 }, { id: 111, weight: 10 },
  { id: 116, weight: 10 }, { id: 118, weight: 10 }, { id: 120, weight: 10 },
  { id: 129, weight: 20 }, { id: 133, weight: 5 }, { id: 140, weight: 2 },
  { id: 138, weight: 2 }, { id: 147, weight: 1 },
  { id: 5, weight: 0.5 }, { id: 8, weight: 0.5 }, { id: 2, weight: 0.5 },
  { id: 26, weight: 0.1 }, { id: 38, weight: 0.1 }, { id: 59, weight: 0.1 },
  { id: 11, weight: 0.1 }, { id: 14, weight: 0.1 }, { id: 17, weight: 0.1 },
  { id: 20, weight: 0.1 }, { id: 22, weight: 0.1 }, { id: 24, weight: 0.1 },
  { id: 30, weight: 0.1 }, { id: 33, weight: 0.1 }, { id: 36, weight: 0.1 },
  { id: 40, weight: 0.1 }, { id: 61, weight: 0.1 }, { id: 64, weight: 0.1 },
  { id: 67, weight: 0.1 }, { id: 70, weight: 0.1 }, { id: 75, weight: 0.1 },
];

export const GREATBALL_WEIGHTED_POOL: WeightedPokemonEntry[] = [
  // Rare evolved and high value pokemon - All standardized to weight 5
  ...
  // Low weight elite evolved pokemon
  { id: 6, weight: 0.1 }, { id: 3, weight: 0.1 }, { id: 9, weight: 0.1 },
  { id: 15, weight: 0.5 }, { id: 12, weight: 0.5 }, { id: 18, weight: 0.5 },
  { id: 34, weight: 0.1 }, { id: 31, weight: 0.1 }, { id: 45, weight: 0.1 },
  { id: 65, weight: 0.1 }, { id: 68, weight: 0.1 }, { id: 94, weight: 0.1 },
  { id: 76, weight: 0.1 }, { id: 149, weight: 0.01 }, { id: 130, weight: 0.01 },
  { id: 62, weight: 0.1 }, { id: 71, weight: 0.1 },
];

export const ULTRABALL_WEIGHTED_POOL: WeightedPokemonEntry[] = [
  { id: 6, weight: 5 }, { id: 3, weight: 5 }, { id: 9, weight: 5 },
  { id: 15, weight: 20 }, { id: 12, weight: 20 }, { id: 18, weight: 20 },
  { id: 34, weight: 15 }, { id: 31, weight: 15 }, { id: 45, weight: 10 },
  { id: 65, weight: 10 }, { id: 68, weight: 10 }, { id: 94, weight: 10 },
  { id: 76, weight: 10 }, { id: 149, weight: 1 }, { id: 130, weight: 3 },
  { id: 62, weight: 10 }, { id: 71, weight: 10 },
];

export const MASTERBALL_WEIGHTED_POOL: WeightedPokemonEntry[] = [
  { id: 151, weight: 1 }, { id: 150, weight: 1 }, { id: 146, weight: 5 },
  { id: 145, weight: 5 }, { id: 144, weight: 5 },
];
...
export const GYM_LEADERS: GymLeader[] = [
  { id: 'brock', name: 'Brock', city: 'Pewter City', badgeName: 'Boulder Badge', pokemon: [{ id: 74, name: 'Geodude' }, { id: 95, name: 'Onix' }], imageUrl: BROCK_IMG, silhouetteUrl: BROCK_IMG, badgeUrl: BOULDER_BADGE },
  { id: 'misty', name: 'Misty', city: 'Cerulean City', badgeName: 'Cascade Badge', pokemon: [{ id: 120, name: 'Staryu' }, { id: 121, name: 'Starmie' }], imageUrl: MISTY_IMG, silhouetteUrl: MISTY_IMG, badgeUrl: CASCADE_BADGE },
  { id: 'lt_surge', name: 'Lt. Surge', city: 'Vermilion City', badgeName: 'Thunder Badge', pokemon: [{ id: 100, name: 'Voltorb' }, { id: 25, name: 'Pikachu' }, { id: 26, name: 'Raichu' }], imageUrl: LTSURGE_IMG, silhouetteUrl: LTSURGE_IMG, badgeUrl: THUNDER_BADGE },
  { id: 'erika', name: 'Erika', city: 'Celadon City', badgeName: 'Rainbow Badge', pokemon: [{ id: 71, name: 'Victreebel' }, { id: 114, name: 'Tangela' }, { id: 45, name: 'Vileplume' }], imageUrl: ERIKA_IMG, silhouetteUrl: ERIKA_IMG, badgeUrl: RAINBOW_BADGE },
  { id: 'koga', name: 'Koga', city: 'Fuchsia City', badgeName: 'Soul Badge', pokemon: [{ id: 109, name: 'Koffing' }, { id: 89, name: 'Muk' }, { id: 110, name: 'Weezing' }], imageUrl: KOGA_IMG, silhouetteUrl: KOGA_IMG, badgeUrl: SOUL_BADGE },
  { id: 'sabrina', name: 'Sabrina', city: 'Saffron City', badgeName: 'Marsh Badge', pokemon: [{ id: 64, name: 'Kadabra' }, { id: 122, name: 'Mr. Mime' }, { id: 49, name: 'Venomoth' }, { id: 65, name: 'Alakazam' }], imageUrl: SABRINA_IMG, silhouetteUrl: SABRINA_IMG, badgeUrl: MARSH_BADGE },
  { id: 'blaine', name: 'Blaine', city: 'Cinnabar Island', badgeName: 'Volcano Badge', pokemon: [{ id: 58, name: 'Growlithe' }, { id: 77, name: 'Ponyta' }, { id: 78, name: 'Rapidash' }, { id: 59, name: 'Arcanine' }], imageUrl: BLAINE_IMG, silhouetteUrl: BLAINE_IMG, badgeUrl: VOLCANO_BADGE },
  { id: 'giovanni', name: 'Giovanni', city: 'Viridian City', badgeName: 'Earth Badge', pokemon: [{ id: 111, name: 'Rhyhorn' }, { id: 51, name: 'Dugtrio' }, { id: 31, name: 'Nidoqueen' }, { id: 34, name: 'Nidoking' }, { id: 112, name: 'Rhydon' }], imageUrl: GIOVANNI_IMG, silhouetteUrl: GIOVANNI_IMG, badgeUrl: EARTH_BADGE }
];

export const AVATAR_OPTIONS: AvatarOption[] = [
  { id: 'red', name: 'Red', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/8/83/FireRed_LeafGreen_Red.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/2/2c/VSRed_Masters.png' },
  { id: 'leaf', name: 'Leaf', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/4/48/FireRed_LeafGreen_Leaf.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/6/65/VSLeaf_Masters.png' },
  { id: 'brock_avatar', name: 'Brock', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/a/a6/Lets_Go_Pikachu_Eevee_Brock.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/7/75/VSBrock_Masters.png', gymLeaderId: 'brock' },
  { id: 'misty_avatar', name: 'Misty', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/f/f6/Lets_Go_Pikachu_Eevee_Misty.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/0/05/VSMisty_Swimsuit_Masters.png', gymLeaderId: 'misty' },
  { id: 'lt_surge_avatar', name: 'Lt. Surge', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/thumb/b/bc/Lets_Go_Pikachu_Eevee_Lt_Surge.png/739px-Lets_Go_Pikachu_Eevee_Lt_Surge.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/5/58/VSLt_Surge_Masters.png', gymLeaderId: 'lt_surge' },
  { id: 'erika_avatar', name: 'Erika', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/4/47/Lets_Go_Pikachu_Eevee_Erika.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/8/86/VSErika_Palentines_2025_Masters.png', gymLeaderId: 'erika' },
  { id: 'koga_avatar', name: 'Koga', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/f/f4/Lets_Go_Pikachu_Eevee_Koga.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/a/ad/VSKoga_Masters.png', gymLeaderId: 'koga' },
  { id: 'sabrina_avatar', name: 'Sabrina', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/7/78/Lets_Go_Pikachu_Eevee_Sabrina.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/4/49/VSSabrina_Masters.png', gymLeaderId: 'sabrina' },
  { id: 'blaine_avatar', name: 'Blaine', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/c/c8/Lets_Go_Pikachu_Eevee_Blaine.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/7/76/VSBlaine_Masters.png', gymLeaderId: 'blaine' },
  { id: 'giovanni_avatar', name: 'Giovanni', profileImageUrl: 'https://archives.bulbagarden.net/media/upload/0/03/USUM_Giovanni.png', navbarSpriteUrl: 'https://archives.bulbagarden.net/media/upload/c/cc/VSGiovanni_Classic_Masters.png', gymLeaderId: 'giovanni' }
];
